...
products = [
    ...
    },
    {
        "name": "Smartphone",
        "price": "$599",
        "img": "https://picsum.photos/400/100?random=2",
    },
    {
        "name": "Headphones",
        "price": "$199",
        "img": "https://picsum.photos/400/100?random=3",
    },
    {
        "name": "Smartwatch",
        "price": "$299",
    ...
    },
    {
        "name": "Camera",
        "price": "$799",
        "img": "https://picsum.photos/400/100?random=6",
    },
]
...
def index():
    ...
    return Titled(
        "Example Store Front!", Grid(*[ProductCard(p) for p in products], cols_lg=3)
    )
